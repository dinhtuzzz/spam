...
def Banner():
    ...
    title = "\n\n\n https://www.facebook.com/profile.php?id=100078811344430"
    banner ="""
 ██████  ███▄ ▄███▓  ██████ 
▒██    ▒ ▓██▒▀█▀ ██▒▒██    ▒ 
░ ▓██▄   ▓██    ▓██░░ ▓██▄   
...
def oldtv360(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "TV360: FAIL!"))
...
def oldloship(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "LOSHIP: FAIL!"))
...
def oldalfrescos(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "ALFRESCOS: FAIL!"))
...
def oldfptshop(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "FPTSHOP: FAIL!"))
...
def oldfacebook(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "FACEBOOK: FAIL!"))
...
def oldzalopay(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "ZALOPAY: FAIL!"))
...
def vieon(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "VIEON: FAIL!"))
...
def ahamove(phone):
    ...
    if Response.status_code == 200:
        ...
        print(format_print("x", "AHAMOVE: FAIL!"))
...
def concung(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "CONCUNG: FAIL!"))
...
def vietid(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "VIETID: FAIL!"))
...
def fptplay(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "FPTPLAY: FAIL!"))
...
def funring(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "FUNRING: FAIL!"))
...
def gotadi(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "GOTADI: FAIL!"))
...
def winmart(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "WINMART: FAIL!"))
...
def moneydong(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "MONEYDONG: FAIL!"))
...
def daihocfpt(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "DAIHOCFPT: FAIL!"))
...
def cafeland(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "CAFELAND: FAIL!"))
...
def oldvayvnd(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "VAYVND: FAIL!"))
...
def oldtamo(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "TAMO: FAIL!"))
...
def oldsenmo(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "SENMO: FAIL!"))
...
def thantaioi(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "THANTAIOI: FAIL!"))
...
def atmonline(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("x", "ATMONLINE: FAIL!"))
...
def Main():
    ...
    while True:
        ...
        if phone in listsdt:
            print(format_print("!", "SAY NO TO SPAM ADMIN PHONE NUMBER")); exit()
        else:
            if len(phone) == 10:
                break
            else:
                print(format_print("!", "PHONE NUMBER MUST BE 10 DIGITS!"))
    while True:
        oldvayvnd(phone)
        oldpops(phone)
        oldtv360(phone)
